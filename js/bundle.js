...
if (document.getElementById('staffs')) {
  var staffsInstance = new _vue2.default({
    ...
    mounted: function mounted() {
      ...
      _axios2.default.get(BASEURL + '/staff?per_page=100').then(function (response) {
...
if (document.getElementById('styles')) {
  var stylesInstance = new _vue2.default({
    el: "#styles",
    data: function data() {
      return {
        styles: [],
    ...
    methods: {
      getThumbUrl: function getThumbUrl(post) {
    ...
    mounted: function mounted() {
      ...
      _axios2.default.get(BASEURL + '/style?_embed&per_page=100').then(function (response) {
        response.data.sort(function (a, b) {
          if (a.id < b.id) return -1;
          if (a.id > b.id) return 1;
          return 0;
...
if (document.getElementById('campaigns')) {
  var campaignsInstance = new _vue2.default({
    el: "#campaigns",
    data: function data() {
      return {
        campaigns: [],
    ...
    mounted: function mounted() {
      ...
      _axios2.default.get(BASEURL + '/campaign?_embed&per_page=100').then(function (response) {
        response.data.sort(function (a, b) {
          if (a.id < b.id) return -1;
          if (a.id > b.id) return 1;
          return 0;
...
if (document.getElementById('color')) {
  var colorInstance = new _vue2.default({
    el: "#color",
    data: function data() {
      return {
        colors: [],
    ...
    mounted: function mounted() {
      ...
      _axios2.default.get(BASEURL + '/item?_embed&per_page=100').then(function (response) {
        response.data.sort(function (a, b) {
          if (a.id < b.id) return -1;
          if (a.id > b.id) return 1;
          return 0;
...
if (document.getElementById('kids')) {
  var kidsInstance = new _vue2.default({
    el: "#kids",
    data: function data() {
      return {
        kids: [],
    ...
    mounted: function mounted() {
      ...
      _axios2.default.get(BASEURL + '/kids?_embed&per_page=100').then(function (response) {
        response.data.sort(function (a, b) {
          if (a.id < b.id) return -1;
          if (a.id > b.id) return 1;
          return 0;
        });
        _this5.kids = response.data;
...
if (document.getElementById('menus')) {
  var menusInstance = new _vue2.default({
    el: "#menus",
    data: function data() {
      return {
        menus: [],
    ...
    mounted: function mounted() {
      ...
      _axios2.default.get(BASEURL + '/menu?_embed&per_page=100').then(function (response) {
        response.data.sort(function (a, b) {
          if (a.id < b.id) return -1;
          if (a.id > b.id) return 1;
          return 0;
        });
        _this6.menus = response.data;
...
if (document.getElementsByClassName('pins')) {
  var pinsInstance = new _vue2.default({
    el: ".pins",
    data: function data() {
      return {
        // element: null,
    ...
    methods: {
      modalOn: function modalOn(img) {
        if (img) (0, _jquery2.default)('.pins__modal_image').attr('src', img);
        (0, _jquery2.default)('.pins__modal').toggleClass('pins__modal_state_on');
      }
    },
    mounted: function mounted() {}
  });
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(251));
